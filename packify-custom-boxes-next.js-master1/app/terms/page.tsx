...
export const metadata: Metadata = {
  title: 'Terms and Conditions | Packify Custom Boxes',
  description: 'Terms and Conditions for Packify Custom Boxes USA. Custom packaging orders, payments, shipping, cancellations. Mailer, rigid, tuck boxes.',
  keywords: 'terms and conditions, Packify Custom Boxes, custom packaging terms USA',
  alternates: { canonical: 'https://packifycustomboxes.com/terms/' },
  openGraph: {
    title: 'Terms and Conditions | Packify Custom Boxes',
    description: 'Custom packaging orders, payments, shipping, cancellations. Mailer, rigid, tuck boxes.',
    url: 'https://packifycustomboxes.com/terms/',
    type: 'website',
    siteName: 'Packify Custom Boxes',
    images: [{ url: '/images/og-image.jpg', width: 1200, height: 630, alt: 'Packify Custom Boxes Terms' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Terms and Conditions | Packify Custom Boxes',
    description: 'Custom packaging orders, payments, shipping, cancellations.',
