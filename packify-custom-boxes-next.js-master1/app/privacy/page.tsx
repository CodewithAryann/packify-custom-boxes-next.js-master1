...
export const metadata: Metadata = {
  title: 'Privacy Policy | Packify Custom Boxes',
  description: 'Privacy Policy for Packify Custom Boxes USA. How we collect, use, protect your data. Custom packaging orders, quotes. GDPR compliant.',
  keywords: 'privacy policy, Packify Custom Boxes, data protection USA',
  alternates: { canonical: 'https://packifycustomboxes.com/privacy/' },
  openGraph: {
    title: 'Privacy Policy | Packify Custom Boxes',
    description: 'How we collect, use, and protect your data. Custom packaging orders. GDPR compliant.',
    url: 'https://packifycustomboxes.com/privacy/',
    type: 'website',
    siteName: 'Packify Custom Boxes',
    images: [{ url: '/images/og-image.jpg', width: 1200, height: 630, alt: 'Packify Custom Boxes Privacy Policy' }],
  },
  twitter: {
