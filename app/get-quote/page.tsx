  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-16 pt-[6rem]">
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Get a Custom Packaging Quote</h1>
        <p className="text-gray-600 text-base max-w-2xl mx-auto mb-6">
          Fill out the form below to receive a personalized quote for your custom boxes. Mailer boxes, tuck boxes, rigid boxes, cosmetic boxes — no minimum order. Free US shipping. 8–10 day turnaround.
        </p>
